...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		List <String> lista = this.getTokens("[a-zA-Z]+");		
	    return lista.size();
	}
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
		List <String> lista = this.getTokens("[^.!?]+");		
	    return lista.size();        
	}
	...
	public static void main(String[] args)
	{
		...
		testCase(new BasicDocument("Lorem ipsum dolor sit amet, qui ex choro quodsi moderatius, nam dolores explicari forensibus ad."),
		         32, 15, 1);*/
		BasicDocument documento = new BasicDocument("This is a test.  How many???  "
		        + "Senteeeeeeeeeences are here... there should be 5!  Right?");
		//List <String> lista = documento.getTokens("[a-z ]+|[0-9]+");
		//List <String> lista = documento.getTokens("[^.,]+");		
		System.out.println("Words: " + documento.getNumWords() + " .Sentences: " +
		documento.getNumSentences() + " .Syllables: " + documento.getNumSyllables());
		System.out.println("El Flesch Score es " + documento.getFleschScore());
