...
public class MainApp extends Application {
	...
	public static void main(String[] args) {
		launch(args);
		EfficientDocument documentoPrueba = new EfficientDocument("Hola. Qué tal?");
		documentoPrueba.processText();
		System.out.println(documentoPrueba.isWord("Esto es una palabra?"));
	}
